				...
				for alignment in blast_record.alignments:
					...
					if model_type_id == 40293:
						...
						for hsp in alignment.hsps:
							...
							orf_protein_sequence, query_snps = self.single_resistance_variant(predicted_genes_dict_protein, submitted_proteins_dict, snp_dict_list, real_query_length, real_sbjct_length, hsp.query, hsp.sbjct_start, hsp.sbjct, hsp.frame, orf_info)
