...
class Variant(MutationsModule):
	...
	def __init__(self, input_type, input_sequence, xml_file, local_database=False):
				...
				for alignment in blast_record.alignments:
					...
					if model_type_id == 40293:
						...
						for hsp in alignment.hsps:
							...
							# eachs = self.indiv_snps(snp_dict_list)
							srv_output = self.single_resistance_variant(predicted_genes_dict_protein, submitted_proteins_dict, snp_dict_list, real_query_length, real_sbjct_length, hsp.query, hsp.sbjct_start, hsp.sbjct, hsp.frame, orf_info)
							...
							for key,value in srv_output.items():								
								...
								if key == "orf_protein_sequence":
									orf_protein_seqence = value
									# print(orf_protein_seqence)
